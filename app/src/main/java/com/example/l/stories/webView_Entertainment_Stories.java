...
public class webView_Entertainment_Stories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.webView__enter_stories);
        ...
        sound = MediaPlayer.create(webView_Entertainment_Stories.this, sound_rec);  //****

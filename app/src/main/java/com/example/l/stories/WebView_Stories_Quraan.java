...
public class WebView_Stories_Quraan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler();
        String storyName = getIntent().getExtras().getString("itemName");
        ...
        sound = MediaPlayer.create(WebView_Stories_Quraan.this, sound_rec);
